...
with co2:
    ...
    T = st.number_input("Número de Interações", value=500, min_value=1, max_value=10000)
...
with co4:    
    ...
    adversarial_prob=A = st.slider("Chance de Haver Adversários", min_value=0.0, max_value=1.0, value=0.20, step=0.01)
